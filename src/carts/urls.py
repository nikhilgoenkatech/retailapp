...
from .views import increase_product_in_cart, remove_from_cart, decrease_product_in_cart, CartDetailView, AddToCartAjax, ConvertCurrency
...
urlpatterns = [
    ...
    path('convert/', ConvertCurrency.as_view(), name='convertcurrency')
]
